...
public class Login {
	...
	public void loginView() throws SQLException {
		...
		JLabel heading = new JLabel("Task_2 :Online Survey System");
		heading.setBounds(0, 50, 450, 50);
		heading.setHorizontalAlignment(JLabel.CENTER);
		heading.setFont(new Font("Times New Roman", Font.BOLD, 30));
		frame.add(heading);
		
		JLabel uname = new JLabel("Username_id : ");
		...
		JLabel upass = new JLabel("Pass_key : ");
		...
		JButton attend = new JButton("Please Go To Survey");
